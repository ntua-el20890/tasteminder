...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'SubmitABugReport',
          path: '/submitABugReport',
          builder: (context, params) => const SubmitABugReportWidget(),
        ),
        FFRoute(
          name: 'Settings',
          path: '/settings',
        ...
        FFRoute(
          name: 'SingIn',
          path: '/singIn',
          builder: (context, params) => const SingInWidget(),
        ),
        FFRoute(
          name: 'SingUp',
          path: '/singUp',
        ...
        FFRoute(
          name: 'PasswordUpdate',
          path: '/passwordUpdate',
          builder: (context, params) => const PasswordUpdateWidget(),
        ),
        FFRoute(
          name: 'Logo',
          path: '/logo',
          builder: (context, params) => const LogoWidget(),
        ),
        FFRoute(
          name: 'ContactUs',
          path: '/contactUs',
